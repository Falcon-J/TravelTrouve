      ...
      <div className="container mx-auto p-6 lg:p-8">
        ...
        >
          ...
          <div className="mb-6">
            <Button
              ...
              variant="ghost"
              className="text-slate-400 hover:text-white hover:bg-slate-800 px-3 py-2 rounded-lg"
            >
        ...
        <Tabs defaultValue="feed" className="space-y-6">
          ...
          <TabsContent value="feed" className="mt-6">
            <GroupFeed key={refreshKey} group={group} />
          </TabsContent>
          ...
          <TabsContent value="members" className="mt-6">
            <div className="text-center py-8">
              <p className="text-slate-400">Members section coming soon...</p>
            </div>
          </TabsContent>
